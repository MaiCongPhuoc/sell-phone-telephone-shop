...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Product create(ProductTempDTO productDTO) {
...
//        }
    ...
    private void uploadAndSaveProductImage(ProductTempDTO productDTO, Product product, ProductMedia productMedia) {
        try {
    ...
    private void uploadAndSaveProductVideo(ProductTempDTO productDTO, Product product, ProductMedia productMedia) {
        try {
